...
\newcommand{\names}{\hspace{-2mm}M. Farebrother -- Marcia Andreychuk}
\newcommand{\playernumber}{Q550794/N357926}
...
\newcommand{\clresponses}{2\,\rh\, GF+ raise} % Resp: line under 1C
...
\newcommand{\ntsptext}{gap positive} % Other meaning for 1NT-2\s
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{gap positive} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{5--5 m weak} % 1NT-3C
\newcommand{\ntdjumptext}{5--5 m GF}
\newcommand{\nthjumptext}{$3=1=(5 4)$}
\newcommand{\ntsjumptext}{$1=3=(5 4)$} % 1NT-3S
...
\newcommand{\ntlebentext}{\hspace{-1mm}Slow Shows} % Lebensohl style

% 2NT
\newcommand{\twonlowtext}{20}
\newcommand{\twonhightext}{21}
\setboolean{pup2n}{true}
\newcommand{\twonsptext}{$\rightarrow$ 3\,NT, one or two minor ST} % 2NT-3S
...
\newcommand{\twocldescribe}{or 8.5 PT w/Defence}
...
\newcommand{\twoclresponse}{2\,NT: \rh\, pos} % Other text on right side of 2C divider
...
\newcommand{\footnotestop}{Leb/reverses} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{Mathe vs. Strong 1\,m, 1\,\bc\ -- p -- 1\,\rd}
...
\newcommand{\firstvstwocl}{\rd\, or Major + minor} % 1NT-2C
\newcommand{\firstvstwodi}{\rh\,+\,\bs} % 1NT-2D
...
\newcommand{\cuebiddescribe}{Mathe vs Str. 1m} % other cuebid comments
...
\newcommand{\threelevelstylebottom}{Aggressive, esp. NV}
...
% vs. opening preempts
\newcommand{\optwontoc}{15--17, stopper} % (2x)-2NT
...
\newcommand{\controlcuetext}{1st/2nd}
\newcommand{\slaminterftext}{DOPI$\rightarrow$5x, DEPO past 5x}
...
\newcommand{\suitAKxvaries}{K/AK after T1} % how?
\newcommand{\KQx}{}
\newcommand{\QJx}{}
\newcommand{\JTx}{}
\newcommand{\TNx}{}
