...
\newcommand{\majraisetext}{Bergen Raises, Kokish GT} % Text line for Bergen, fitjumps, etc
...
\newcommand{\footnotestop}{Leb/reverses, UvU (low shows low)} % 2 lines for additional conventions at bottom
...
\newcommand{\opdtothru}{3\,\bs} % Takeout through...
