...
% README: [Our card with Nicola from Ajijic.  Pretty straight LCDBC 2/1, with Suction to make her happy.]
\newcommand{\names}{\hspace{-3mm}Michael Farebrother --- Nicola Beninger}
\newcommand{\playernumber}{Q550794/P576846}

% General approach:
\newcommand{\generalapproach}{2/1 GF}
\newcommand{\minHCPopen}{(11)12}
\newcommand{\minHCPresp}{6 or A}
...
\newcommand{\majraisetext}{3\,\bc\ LR, 3\,\rd\ 7--9} % Text line for Bergen, fitjumps, etc
...
\newcommand{\sysontext}{\hspace{3mm}X, 2\,\bc} % Systems on after 1NT-(X), 2\c, etc...
...
\newcommand{\nthjumptext}{\redreg{5-5 Majors INV}}
\newcommand{\ntsjumptext}{\redreg{5-5 Majors GF}} % 1NT-3S
...
\newcommand{\ntlebentext}{FADS} % Lebensohl style
...
\newcommand{\twonothertext}{3NT: 5\,\bs--4\,\rh} % Other line in 2NT box
...
% Bottom of card
\newcommand{\jshifttext}{PRE m \textrightarrow M, \redreg{Bergen/M}} % jump shift responses
...
\newcommand{\footnotestop}{Unu. vs. Unu. (low = Low)} % 2 lines for additional conventions at bottom
...
\newcommand{\firstvstwocl}{\redreg{\rd\ or \rh\ + \bs}} % 1NT-2C
\newcommand{\firstvstwodi}{\redreg{\rh\ or \bs\ + \bc}} % 1NT-2D
\newcommand{\firstvstwohe}{\redreg{\bs\ or \bc\ + \rd}} % 1NT-2H
\newcommand{\firstvstwosp}{\redreg{\bc\ or \rd\ + \rh}} % 1NT-2S
\newcommand{\firstvstwont}{\hspace{3mm}\redreg{\bc\ + \rh}} % 1NT-2NT
...
\newcommand{\othernt}{3\,\bc: \rd\ + \bs} % other NT defense info
...
\newcommand{\threelevelstylebottom}{\hspace{3mm}Reasonable, esp. 2\textsuperscript{nd}}
...
\newcommand{\opcuebid}{3 lev. stopper ask}
\newcommand{\opjumpoc}{\redreg{Leaping Michaels}}
...
\newcommand{\trumpsignaltext}{suit pref}
