...
% README: [Starr (and possibly Glen).  Another Alberta 2/1.  A bit sketchy, probably should be treated as draft.]
\newcommand{\names}{MF / EK --- Starr Bulmer}
\newcommand{\playernumber}{Q550794/J800949}
...
\newcommand{\ntsptext}{either minor} % Other meaning for 1NT-2\s
...
\newcommand{\twohdescribe}{Disciplined 1+2}
...
\newcommand{\twosdescribe}{Disciplined 1+2}
...
% Bottom of card
\newcommand{\jshifttext}{Soloway, WJS/comp} % jump shift responses
...
\newcommand{\firstvstwocl}{\redreg{Single Suit}} % 1NT-2C
\newcommand{\firstvstwodi}{\redreg{\rh\ + \bs}} % 1NT-2D
...
\newcommand{\slaminterftext}{D/R0P1, DEPO \textrightarrow 5 trump}
