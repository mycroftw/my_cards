...
% README: [Card with the Wandlers.  Pretty simple 2/1.]
\newcommand{\names}{Michael Farebrother --- Marjorie Wandler}
...
\newcommand{\ntsptext}{msStayman} % Other meaning for 1NT-2\s
...
\newcommand{\twoclresponse}{Cheapest 3 2\textsuperscript{nd} neg} % Other text on right side of 2C divider
...
% Bottom of card
\newcommand{\jshifttext}{Preemptive m \textrightarrow M, \redreg{Bergen  on/X}} % jump shift responses
...
\newcommand{\firstvstwocl}{\hspace{2mm}\redreg{one suit}} % 1NT-2C
