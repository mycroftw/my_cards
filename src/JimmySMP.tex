...
\newcommand{\bidsprepbottom}{\hspace{-3mm}1\,\rd: 2+\,\rd, 11-15 Unbal, 11-13 BAL.\hspace{3mm}1\,\rh, \bs: ``10s that look like 11''} % Bids that Require Prep line 2
...
\newcommand{\majothertexttop}{\textcolor{black}{10+\,--15}} % Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\sysontext}{\hspace{-2mm}X, 2\,\bc} % Systems on after 1NT-(X), 2\c, etc...
