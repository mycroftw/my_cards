...
% README: [Precision based on DJNeill's Simple Modern Precision.]
\newcommand{\names}{\hspace{-3mm}Jimmy Reynolds -- Michael Farebrother}
\newcommand{\playernumber}{\hspace{1.5mm}O375243/Q550794}

% General approach:
\newcommand{\generalapproach}{Precision}
\newcommand{\minHCPopen}{10(9 nv,M)}
...
\newcommand{\bidspreptop}{1\,\bc \ 16+ Unbal, 17+ BAL} % Bids that Require Preparation
\newcommand{\bidsprepbottom}{1\,\rh, \bs\ NV: ``9s that looks like 10s'', V: ``10s that look like 11s''} % Bids that Require Prep line 2
...
\newcommand{\cldescribe}{any 16+ unbal, 17+ bal} % blank space under 1C
\newcommand{\clresponses}{\redreg{1\,\rh: min GF, 1\,\bs+: 12+ by UPH}~[\ref{itm:1c_resp}]} % Resp: line under 1C
%\setboolean{ctxfr}{true} % transfer responses to 1C

\newcommand{\clrespdi}{\redreg{0--7 any}~[\ref{itm:1c1d_rebid}]} % text after "1D response"
%\setboolean{bypas}{true}
\newcommand{\minonenlowtext}{12} % 1C-1NT range
\newcommand{\minonenhightext}{+}
\newcommand{\mintwonlowtext}{12+} % 1C-2NT range
\newcommand{\mintwonhightext}{\redreg{4441}}
...
\newcommand{\didescribe}{11--13 BAL, 11--15 unbal, (332)\bc5 possible} % blank space under 1D. e.g ''4 unless 4-4-3-2''
\newcommand{\diresponses}{\redreg{2\,M: 5\,\bs/4\,\rh\. \rh: 8--10,\,\bs: LR; 3\bc\,both m}~[\ref{itm:1d_resp}]}
%\setboolean{dascl}{true} % 1D responses like 1C

\newcommand{\minonedionenlowtext}{7} % 1D-1NT range
\newcommand{\minonedionenhightext}{11}
\newcommand{\minoneditwonlowtext}{12} % 1D-2NT range
\newcommand{\minoneditwonhightext}{13}
...
\newcommand{\majothertexttop}{\textcolor{black}{10+\,--15 Vul, 9+\,--15 NV}} % Other major methods: HSGT, Mathe asking bid, etc
...
\newcommand{\majraisetext}{limit SPL, Fit Jumps/comp+PH} % Text line for Bergen, fitjumps, etc
...
\newcommand{\altntresponse}{5M332, 22(45), 444-A/K common}
...
\newcommand{\ntsptext}{clubs} % Other meaning for 1NT-2\s
%\setboolean{nat2n}{true}
\setboolean{trf2n}{true}
\newcommand{\ntnttext}{diamonds} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{\redreg{Puppet Stayman}} % 1NT-3C
\newcommand{\ntdjumptext}{\redreg{5--5 minors GF}}
\newcommand{\nthjumptext}{\redreg{1=3=(54)}}
\newcommand{\ntsjumptext}{\redreg{3=1=(54)}} % 1NT-3S
...
\newcommand{\twonsptext}{one- or two- minor ST} % 2NT-3S
...
\newcommand{\threenonesuittext}{Solid suit, 0 outside controls} % One suit description 3NT box

% 2 Clubs
\newcommand{\twoclowtext}{11} % 2C point range
\newcommand{\twochightext}{15}
\newcommand{\twocldescribe}{6+ clubs}
...
\newcommand{\twoclresponse}{2\,\rd\ INV+ inq, 2 M NFC} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{11} % 2D point range
\newcommand{\twodhightext}{15}
\newcommand{\twoddescribe}{three-suited, short \rd}
...
\newcommand{\twodntresp}{\redreg{\bc\,min, \rd: 4=4 M, M: 3-cd}}
\newcommand{\twodresponse}{}

% 2 Hearts
\newcommand{\twohlowtext}{4}
\newcommand{\twohhightext}{10-}
\newcommand{\twohdescribe}{aggressive, esp. NV and 1st}
...
% 2 Spades
\newcommand{\twoslowtext}{4}
\newcommand{\twoshightext}{10-}
\newcommand{\twosdescribe}{as 2\,\rh}
...
% Bottom of card
\newcommand{\jshifttext}{\redreg{1\,\rd\: see above; 1 M Lim Spl, Fit Jumps by PH or in comp}} % jump shift responses
...
\newcommand{\footnotestop}{vs. comp/1\,\bc\: P: 0--4 or trap, X: 4--7, bid: GF} % 2 lines for additional conventions at bottom
...
\newcommand{\doubleothertext}{\textcolor{black}{2 lvl freq. T/O, 3 lvl freq. DSI}} % Other special doubles
...
\newcommand{\firstvstwocl}{\hspace{2mm}\bc\ + M} % 1NT-2C
\newcommand{\firstvstwodi}{\hspace{2mm}\rd\ + M} % 1NT-2D
\newcommand{\firstvstwohe}{\hspace{5mm}\rh} % 1NT-2H
\newcommand{\firstvstwosp}{\hspace{5mm}\bs} % 1NT-2S
\newcommand{\firstvstwont}{\hspace{2.5mm}\bc\,+\,\rd} % 1NT-2NT
...
\newcommand{\threelevelstylebottom}{\hspace{6mm}Aggressive, esp. majors}
...
\newcommand{\gerbertext}{NT-seq/last NT only}
...
\newcommand{\controlcuetext}{1\textsuperscript{st}/2\textsuperscript{nd} up the line}
...
\begin{footnotesize}
    \begin{enumerate}
        ...
        \begin{description}
            ...
            \item [2\,\bc-2\,\rh] 12+, 5+suit
            \item [2\,\bs] 12+, any 4441.
                2NT asks, then 4\,\bc/\rd/NT\@.
            \item[Passed hand] 1\,\rd still negative, others 8--10 5+; 2\,\bs 8--10 any 4441.
        \end{description}
        ...
        \begin{enumerate}[label*=\arabic*,nosep]
            ...
            \begin{description}
                \item [2\,\rh] 11--13 Balanced.
                    Responses:~[\ref{itm:1d2m2h_resp}]
                \item [2\,\bs] unspecified splinter raise.
                    2\,NT asks, responses high/middle/low.
                \item [2\,NT] Over 2\,\bc, shortness in clubs (usually 4441).
                    Over 2\,\rd, 6+\,\rd.
            \end{description}
            \item \label{itm:1d2m2h_resp} After 1\,\rd-2\,m; 2\,\rh\ (11-13 balanced):
            \begin{description}
