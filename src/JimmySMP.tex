...
\newcommand{\names}{\hspace{-2.5mm}Jimmy Reynolds -- Michael Farebrother}
\newcommand{\playernumber}{\hspace{0.5mm}O375243/Q550794}

% General approach:
\newcommand{\generalapproach}{Precision}
\newcommand{\minHCPopen}{10(9nv,M)}
...
\newcommand{\bidsprepbottom}{NV: 1\,\rh, \bs\ "9s that looks like 10s"} % Bids that Require Prep line 2
...
\newcommand{\cldescribe}{16+ unbal, 17+ bal} % blank space under 1C
\newcommand{\clresponses}{1\,\rd: neg, 1\,\rh: min GF, 1\,\bs+: 12+} % Resp: line under 1C
%\setboolean{ctxfr}{true} % transfer responses to 1C

\newcommand{\clrespdi}{0-7 any} % text after "1D response"
...
\newcommand{\mintwonhightext}{short}
...
\newcommand{\diresponses}{2\,\rh: 5\,\bs + 4\,\rh\,8--10, 2\,\bs: LR, 3\,\bc: GF Raise}
%\setboolean{dascl}{true} % 1D responses like 1C

\newcommand{\minonedionenlowtext}{8} % 1D-1NT range
...
\newcommand{\twoclresponse}{2\,\rd\ INV+ inq, 2 M NFConst} % Other text on right side of 2C divider
...
\newcommand{\twodntresp}{shape inquiry}
...
% Bottom of card
\newcommand{\jshifttext}{1\,\rd\: see above; 1 M Lim Spl; Fit Jumps/PH or comp} % jump shift responses
