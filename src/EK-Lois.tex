...
% README: [Ellen with Lois.  2/1 Calgary style.]
\newcommand{\names}{Ellen Kuiper -- Lois Matton}
\newcommand{\playernumber}{6007899/5352584}
...
\newcommand{\clresponses}{2\,\rd: Slam try in \bc} % Resp: line under 1C
...
\newcommand{\didescribe}{\hspace{5mm}4 unless 4=4=3=2} % blank space under 1D. e.g ''4 unless 4-4-3-2''
\newcommand{\diresponses}{3\,\bc: Slam try in \rd}
...
\newcommand{\twonsptext}{both minors} % 2NT-3S
...
\newcommand{\threenonesuittext}{0 outside} % One suit description 3NT box
...
\newcommand{\twoclresponse}{2NT = hearts} % Other text on right side of 2C divider
...
\label{sec:misc}
\newcommand{\jshifttext}{1m: J/S in om ST Raise} % jump shift responses
...
\newcommand{\footnotestop}{Unusual v Unusual (low shows low)} % 2 lines for additional conventions at bottom
...
\newcommand{\firstcondition}{\hspace{-2mm}All/All} % ''vs.'' line, first half
\newcommand{\firstvsdbl}{\hspace{3mm}Strong}   % 1NT-X
\newcommand{\firstvstwocl}{\redreg{\rd\ or Major + minor}} % 1NT-2C
\newcommand{\firstvstwodi}{\hspace{3mm}\redreg{\rh\ +\ \bs}} % 1NT-2D
\newcommand{\firstvstwohe}{\hspace{5mm}\regtext{\rh}} % 1NT-2H
\newcommand{\firstvstwosp}{\hspace{5mm}\regtext{\bs}} % 1NT-2S
...
\newcommand{\threelevelstylebottom}{\hspace{3mm}Sound VUL, light NV}
...
\newcommand{\slaminterftext}{D0P1, DEPO \textrightarrow\ 5suit}
