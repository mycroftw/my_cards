...
% README: [Our "normal" system.  K/S (2/1, weak NT) with Keri, Power Doubles and other weirdness.]
...
\newcommand{\majothertextbottom}{\regtext{2/1 GF unless Suit Rebid}, unusual responses to J2N~\boldtext{[\ref{itm:jacoby2nt}]}} %Other major methods line two

\setboolean{ra2nt}{true} %Jacoby
\setboolean{ra3nt}{true} %1M-3NT
\setboolean{raspl}{true} %Splinter
\newcommand{\majraisetext}{Fit J/S, ~LR strength~\boldtext{[\ref{itm:jshift}]}} %Text line for Bergen, fitjumps, etc
...
\label{sec:misc}
\newcommand{\jshifttext}{Fit (Limit-ish, 9+ in two suits)~\boldtext{[\ref{itm:jshift}]}} % jump shift responses
...
\newcommand{\othercardingtextone}{\boldtext{U/D Suit Pref.~[\ref{itm:carding}]}}
...
\drawconventioncard
\newpage
\centerline{\large\textbf{Notes for Michael Farebrother --- Ellen Kuiper: K/S system: \today{}}}
\begin{footnotesize}
    \begin{enumerate}
        \item \label{itm:1nt}1 NT is 12--14 all seats, all vulnerabilities.
         We upgrade special 11s (Michael more than Ellen).
        \begin{enumerate}[label*=\arabic*,nosep]
            \item \label{itm:1nt2c}We do \textbf{not} play Stayman over 1 NT\@.
            2\,\bc\ is Keri: a puppet to 2\,\rd.
            ...
            \begin{description}[nosep]
                ...
                \item [3 M] GF, 5+ \textbf{diamonds} and 4 of the major
            ...
            \begin{description}[nosep]
                \item [1 NT--2\,\rd] hearts.
                      Very rarely 4: if responder rebids 2\,\bs, they are INV with both majors:
                      5\,\bs--5\,\rh, 5\,\bs--4\,\rh\ or 4\,\bs--4\,\rh, but not 4\,\bs--5\,\rh.
            ...
            \end{itemize}
        \end{enumerate}
        \item \label{itm:jshift}We play Fit Jump Shifts (9+ cards in partner's suit and the bid suit of quality, limit raise-ish values).
        \item \label{itm:jacoby2nt}
        \begin{description}[nosep]
            \item Responses to 1M-2NT:
            \item [3\,\bc] All minimums.
                  3\,\rd asks, shortness shown as below; otherwise cue at 4 level.
            \item[3\,\rd] Extras, no shortness.
            \item[3\,\rh] Extras, club shortness (related minor)
            \item[3\,\bs] Extras, diamond shortness
            \item[3\,NT] Extras, other major shortness
            \item[4\,x] Second suit of trick-taking power
            \item[4\,M] Dead minimum, almost certainly 5M332, at most 1 control.
        \end{description}
