...
% README: [Card with Steve Lawrence.  Calgary 2/1 again..]
\newcommand{\names}{\hspace{-2.5mm}Michael Farebrother -- Steve Lawrence}
\newcommand{\playernumber}{Q550794/P174160}
...
\newcommand{\clresponses}{2\,\rd\ Limit Raise} % Resp: line under 1C
...
\newcommand{\majraisetext}{mini-Maxi Splinters} % Text line for Bergen, fitjumps, etc
...
\newcommand{\ntdjumptext}{\hspace{0.5mm}\redreg{5--5+ m GF+}}
\newcommand{\nthjumptext}{Hearts slam try}
\newcommand{\ntsjumptext}{Spades slam try} % 1NT-3S
...
\newcommand{\twonsptext}{Puppet to 3NT} % 2NT-3S
...
\newcommand{\threenonesuittext}{solid minor, 0 A/K O/S} % One suit description 3NT box

% 2 Clubs
\newcommand{\twoclowtext}{} % 2C point range
\newcommand{\twochightext}{Big}
\newcommand{\twocldescribe}{22+ or 8.5+ PT w/def}
...
\newcommand{\twoclresponse}{2\,NT: \rh, X, XX Neg, P GF} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{7} % 2D point range
\newcommand{\twodhightext}{11}
\newcommand{\twoddescribe}{Sensible, esp. 2\textsuperscript{nd}}
...
% Bottom of card
\newcommand{\jshifttext}{Preemptive m \textrightarrow M only, Fit J/S in comp or PH} % jump shift responses
...
\newcommand{\footnotestop}{Unusual v Unusual (Low = Low)} % 2 lines for additional conventions at bottom
...
\newcommand{\ballowtext}{10} % balancing range
...
\newcommand{\ntothertext}{S/W NT (Shapely)} % conventional overcalls (sandwich etc)
...
\newcommand{\firstvsdbl}{\hspace{2mm}Strong}   % 1NT-X
\newcommand{\firstvstwocl}{\redreg{\rd\ or M + m}} % 1NT-2C
\newcommand{\firstvstwodi}{\hspace{3mm}\redreg{\rh\ +\ \bs}} % 1NT-2D
\newcommand{\firstvstwohe}{\hspace{5mm}\rh} % 1NT-2H
\newcommand{\firstvstwosp}{\hspace{5mm}\bs} % 1NT-2S
\newcommand{\firstvstwont}{\hspace{3mm}\redreg{\bs\ +\ \rd}} % 1NT-2NT
...
\newcommand{\xxtext}{Defensive Values} % Conventional XX explanation
...
\newcommand{\threelevelstylebottom}{\hspace{3mm}Light NV, sounder Vul}
\newcommand{\threelevelresp}{}
\newcommand{\fourlevelstyle}{Same}
\newcommand{\fourlevelresp}{}
%\setboolean{namya}{true}
\newcommand{\fourlevelother}{}

% vs. opening preempts
\newcommand{\optwontoc}{15\,--\,17} % (2x)-2NT
...
\newcommand{\blackwoodtext}{Specific K/5NT}
\newcommand{\controlcuetext}{1\textsuperscript{st} / 2\textsuperscript{nd}}
\newcommand{\slaminterftext}{D0P1, DEPO \textrightarrow\ 5 trump}
