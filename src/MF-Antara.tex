...
% README: [Pretty standard Calgary 2/1.  Multi-Landy vs NT, Bergen Raises, X-Cross Constructive.]
\newcommand{\names}{\hspace{-2mm}Michael Farebrother --- Antara Keelor}
\newcommand{\playernumber}{Q550794/O766129}
...
\newcommand{\bidsprepbottom}{Bergen Raises/1M, Multi-Landy vs 1NT} % Bids that Require Prep line 2
...
\newcommand{\clresponses}{\redreg{2\,\rd\ ART Limit Raise}} % Resp: line under 1C
...
\newcommand{\diresponses}{\redreg{3\,\bc\ ART Limit Raise}}
...
\newcommand{\majraisetext}{Bergen Raises (3\,\rd\ Limit)} % Text line for Bergen, fitjumps, etc
...
\newcommand{\altntresponse}{all 5332}
...
\newcommand{\ntsptext}{\bc\,or\,\rd, wk/str} % Other meaning for 1NT-2\s
\setboolean{nat2n}{true}
%\setboolean{trf2n}{true}
\newcommand{\ntnttext}{} % Other meaning for 1NT-2NT

% 1NT: Second column
\newcommand{\ntcjumptext}{\redreg{GF Puppet Stayman}} % 1NT-3C
\newcommand{\ntdjumptext}{\redreg{5=5 minors}}
\newcommand{\nthjumptext}{\redreg{3=1=(45)}}
\newcommand{\ntsjumptext}{\redreg{1=3=(45)}} % 1NT-3S
...
\newcommand{\threenonesuittext}{0 controls outside} % One suit description 3NT box

% 2 Clubs
\newcommand{\twoclowtext}{Big} % 2C point range
\newcommand{\twochightext}{}
\newcommand{\twocldescribe}{or 4 losers w/5+controls}
...
\newcommand{\twoclresponse}{2NT = \rh} % Other text on right side of 2C divider

% 2 Diamonds
\newcommand{\twodlowtext}{5} % 2D point range
\newcommand{\twodhightext}{10}
\newcommand{\twoddescribe}{Aggressive, sounder 2\textsuperscript{nd} or VUL}
...
% Bottom of card
\newcommand{\jshifttext}{Preemptive m/M and comp, \redreg{Bergen/1M, om/1m LR}} % jump shift responses
...
\newcommand{\footnotestop}{Unusual vs Unusual (Low shows low)} % 2 lines for additional conventions at bottom
\newcommand{\footnotesbottom}{\redreg{Mathe vs 1\,\bc\ --\ 1\,\rd}}
...
\newcommand{\ntothertext}{Sandwich NT (shapely)} % conventional overcalls (sandwich etc)
...
\newcommand{\overcallcuetext}{LR+ or v. strong}
...
\newcommand{\firstvstwocl}{\hspace{1mm}\rh\ and\ \bs} % 1NT-2C
\newcommand{\firstvstwodi}{\hspace{2mm}\rh\ or\ \bs} % 1NT-2D
\newcommand{\firstvstwohe}{\rh\,+ minor} % 1NT-2H
\newcommand{\firstvstwosp}{\bs\,+ minor} % 1NT-2S
\newcommand{\firstvstwont}{\hspace{0.9mm}\bc\ and\ \rd} % 1NT-2NT
...
\newcommand{\cuebiddescribe}{Mathe vs STR ART 1m} % other cuebid comments
...
% Opening preempts
\newcommand{\threelevelstyletop}{aggressive}
...
% vs. opening preempts
\newcommand{\optwontoc}{15+\,--\,19} % (2x)-2NT
...
\newcommand{\blackwoodtext}{Majors, 3014 for minors}
\newcommand{\controlcuetext}{1\textsuperscript{st} + 2\textsuperscript{nd}}
\newcommand{\slaminterftext}{DOP1, DEPO 5 trump or higher}
...
\newcommand{\prcourank}{}
\newcommand{\prsuirank}{}
\newcommand{\signalexcepttext}{vs. NT, K=Kount/unblock}
...
\newcommand{\suitxx}{1}
\newcommand{\suitxxx}{1}
\newcommand{\suitxxxx}{1}
\newcommand{\suitxxxxx}{1}
\newcommand{\suitHxx}{}
\newcommand{\suitHxxx}{}
\newcommand{\suitHxxxx}{}
