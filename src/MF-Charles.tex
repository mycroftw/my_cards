...
% README: [Charles C. 2/1.]
\newcommand{\names}{\hspace{-3mm}Michael Farebrother --- Charles Chartier}
\newcommand{\playernumber}{Q550794/K571862}
...
\newcommand{\majraisetext}{3\,\bc\ 7--9, 3\,\rd\ LR} % Text line for Bergen, fitjumps, etc
...
\newcommand{\twoclstepstext}{Controls}
%\setboolean{neg2h}{true}
\newcommand{\twoclresponse}{0-1,2,AK,KKK,4+} % Other text on right side of 2C divider
...
\newcommand{\overcallcuetext}{F1, J/Cue Mixed}
...
\newcommand{\firstvsdbl}{\redreg{\bc\ or \rd\ or \rh+\bs}}   % 1NT-X
\newcommand{\firstvstwocl}{\hspace{2mm}\redreg{\bc\ + Major}} % 1NT-2C
\newcommand{\firstvstwodi}{\hspace{2mm}\redreg{\rd\ + Major}} % 1NT-2D
\newcommand{\firstvstwohe}{\hspace{6mm}\rh} % 1NT-2H
\newcommand{\firstvstwosp}{\hspace{6mm}\bs} % 1NT-2S
